      ...
      <footer id="contact" className="bg-slate-950 pt-20 pb-10 border-t border-slate-900">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="flex justify-center gap-6 mb-12">
            ...
            <a href={profileData.social.email} className="p-3 bg-slate-900 rounded-full text-slate-400 hover:text-white hover:bg-slate-800 transition-all border border-slate-800">
